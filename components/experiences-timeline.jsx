            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
                <li className="px-2">
                    ...
                    <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                        I did my internship in Zaragoza, Spain. I successfully completed the task of creating a dynamic website for the company I worked for. I also gained experience in the field of web development.
                    </p>
                </li>
